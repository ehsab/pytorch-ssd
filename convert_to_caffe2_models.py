...
init_net_txt_path = "models/{net_type}_init_net.pbtxt"
predict_net_path = "models/{net_type}_predict_net.pb"
predict_net_txt_path = "models/{net_type}_predict_net.pbtxt"
...
print("Save the model in binary format to the files {init_net_path} and {predict_net_path}.")
...
print("Save the model in txt format to the files {init_net_txt_path} and {predict_net_txt_path}. ")
